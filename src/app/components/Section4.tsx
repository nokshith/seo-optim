...
export default function Section4() {
    const items = [
        "Industrial IoT : meters, analyzers, PLCs, SCADA, edge gateways",
        "ERP : cost centers, procurement contracts, pricing models",
        "ESG Platforms : sustainability disclosures, voluntary frameworks",
        "Financial Systems : carbon hedging instruments, market indexes",
        "Laboratory Systems : material specific emissions coefficients",
    ];
    return (
        <div className="w-full h-auto min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:h-[680px] bg-white rounded-t-[10px] shadow-[0px_4px_14px_-5px_rgba(0,0,0,0.25)] px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 md:py-16 lg:py-20">
            <div className="relative w-full h-full">
                <div className="w-full max-w-[1207.94px] h-auto min-h-[300px] sm:min-h-[350px] md:min-h-[400px] lg:h-[446px] bg-white mx-auto flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-[120px] opacity-100">
                    ...
                    {/* Text Box */}
                    <div className="w-full lg:w-[592px] h-auto lg:h-[415px] rounded-[8px] opacity-100 order-2 lg:order-2 mt-4 sm:mt-6 md:mt-8 lg:mt-10">
