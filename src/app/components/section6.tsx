...
export default function Section6() {
    const items = [
       "Immutable transactional event ledger",
    "Fully transparent emissions factor versioning",
    "Multi-role audit readiness for CFO, board, investors, regulators",
    "Time-stamped variance explanations for third-party audit attestation",
    "Complete GHG Protocol alignment embedded into every process record",
    ];
    return (
        <div className="w-full h-auto min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:h-[680px] bg-white rounded-t-[10px] shadow-[0px_4px_14px_-5px_rgba(0,0,0,0.25)] px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 md:py-16 lg:py-20">
            <div className="relative w-full h-full">
                <div className="w-full max-w-[1207.94px] h-auto min-h-[300px] sm:min-h-[350px] md:min-h-[400px] lg:h-[446px] bg-white mx-auto flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-[120px] opacity-100 items-center">
                    {/* Text Box */}
                    <div className="w-full lg:w-[592px] h-auto lg:h-[415px] rounded-[8px] opacity-100 order-1 lg:order-1 flex flex-col justify-center">
                        ...
                        <div className="w-full h-auto mt-4 sm:mt-6 lg:mt-[22px] opacity-100 flex items-center justify-center lg:justify-start">
                            <h4
                                ...
                                style={{ fontFamily: "Segoe UI" }}
                            >
                                Every action, fully traceable and secure.
                            </h4>
                        </div>
                    ...
                    <div className="w-full lg:w-[490px] h-[200px] sm:h-[250px] md:h-[300px] lg:h-[446px] relative opacity-100 order-2 lg:order-2">
                        <Image
                            src="/images/s6.png"
                            alt="Governance Architecture Interface"
                            fill
